...
output_dir = './type_classification_model_save/'
model_dir = './type_classification_model_save/pytorch_model.bin'


# train dataset file
DATASET_PATH = '../inputs/datasets/'
TRAIN_DATASET_FNAME = 'train_resampled_final.csv'
TEST_DATASET_FNAME = 'valid_resampled_final.csv'
