...
class BertDataset:
    def __init__(self,entity1,text,label):
        """
        parameters:
...
#         print(len(self.entity1))
#         print(len(self.text))
#         print(len(self.text) + len(self.entity1))
#         print(len(self.text + self.entity1))
        return len(self.text)
    
    def __getitem__(self,item):
        # for any given item index, return a dictionary of inputs
        entity1=str(self.entity1[item])
